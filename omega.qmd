...
* Konstruk harus memenuhi asumsi *tau equivalence*, yaitu kondisi dimana setiap aitem memiliki *factor loading* yang identik. Artinya, setiap aitem **harus sama kontribusinya** (*covariance*) dalam menjelaskan konstruk. Perlu diingat, hal ini adalah kondisi yang **tidak mungkin terjadi** di dunia nyata.
...
* Setiap item harus independen, sehingga *error* nya tidak boleh berkorelasi.
